 ...
 *  - LV_USE_GUIDER_SIMULATOR / LV_USE_FREEMASTER are not used, so the
 *    "gg_external_data.h" include is dropped.
 *  - The global `lv_ui guider_ui;` instance is defined here.
 */
...
void init_keyboard(lv_ui *ui)
{
    ...
    /* 键盘含退格/换行/大小写等 LVGL 私有符号，使用内置字体保证符号字形完整。 */
    lv_obj_set_style_text_font(ui->g_kb_top_layer, LV_FONT_DEFAULT, LV_PART_MAIN|LV_STATE_DEFAULT);
}
